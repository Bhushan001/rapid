...
public class MessageConstants {
    ...
    public static final String CLIENT_CREATION_MESSAGE = "Client created successfully";
    public static final String CLIENT_UPDATED_MESSAGE = "Client updated successfully";
    public static final String CLIENT_DELETED_MESSAGE = "Client deleted successfully";
    ...
    public static final String ROLE_CREATION_MESSAGE = "Role created successfully";
